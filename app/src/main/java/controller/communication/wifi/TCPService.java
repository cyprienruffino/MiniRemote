...
public class TCPService extends SurService {
    ...
    private synchronized void privateSend(EventWrapper e, final SendFinished callback, final ErrorInterface errorInterface) {
        if (running) {
    ...
    public void startServer(final int port, final InetAddress address) {
