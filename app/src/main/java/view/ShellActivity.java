...
public class ShellActivity extends Activity implements ErrorInterface {
    ...
    public void writeToTerminal(String text){
        final TextView textView= (TextView) findViewById(R.id.shell_view);
        final String newText= ((String) textView.getText()).concat(System.getProperty("line.separator")+" "+text);
